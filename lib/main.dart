...
// Member 1: Greena Nisheethkumar Patel
// Student ID: 002986028
// Member 2: Sai Anuradha Kappaganthula
// Student ID: 002993845
...
class _ControlDeckScreenState extends State<ControlDeckScreen> {
  ...
  // 🐛 BUG #1 FIX:
  // Pressed state belongs to each TactileButton, not the screen.
  // The shared screen-level isPressed variable has been removed.
        ...
        child: Column(
          children: [
            ...
            Slider(
              ...
              // 🐛 BUG #2 FIX:
              // setState tells Flutter to rebuild the energy text.
              onChanged: (newVal) {
                setState(() {
                  powerLevel = newVal;
                });
...
// 🐛 BUG #1 FIX:
// StatefulWidget gives every button its own independent isPressed state.
...
class _TactileButtonState extends State<TactileButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      // 🐛 BUG #4 FIX:
      // Touch-down changes appearance but does not trigger the action.
      onTapDown: (_) {
        setState(() {
          isPressed = true;
        });
      ...
      // The action runs when the user releases the button.
      onTapUp: (_) {
        setState(() {
          isPressed = false;
        });
      ...
      // A cancelled gesture resets appearance without running the action.
      onTapCancel: () {
        setState(() {
          isPressed = false;
        });
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          // 🐛 BUG #3 FIX:
          // Pressed = smaller shadows; released = larger raised shadows.
          boxShadow: isPressed
              ? [
                  BoxShadow(
